...
export function EditEmployeeClient({ employee, departments, allEmployees }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    onContract: ["contract", "temporary"].includes(employee.contractType ?? ""),
    contractType: ["contract", "temporary"].includes(employee.contractType ?? "") ? (employee.contractType as string) : "contract",
